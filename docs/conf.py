...
_mod = importlib.import_module("quetz_sql_authenticator")


project = "quetz_sql_authenticator"
...
apidoc_module_dir = "../quetz_sql_authenticator"
...
def linkcode_resolve(domain, info):
    ...
    return (
        "https://github.com/mamba-org/quetz-sql-authenticator"
