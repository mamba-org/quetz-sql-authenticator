...
@router.get(
    "/api/sqlauth/credentials/{username}",  # noqa
    tags=["sqlauth"],
)
def _get(
    username: str,
...
@router.post("/api/sqlauth/credentials/{username}", tags=["sqlauth"])  # noqa
def _create(
    username: str,
    password: str,
    auth: authorization.Rules = Depends(get_rules),
...
@router.put("/api/sqlauth/credentials/{username}", tags=["sqlauth"])  # noqa
def _update(
    username: str,
    password: str,
    auth: authorization.Rules = Depends(get_rules),
...
@router.delete("/api/sqlauth/credentials/{username}", tags=["sqlauth"])  # noqa
def _delete(
    username: str,
    auth: authorization.Rules = Depends(get_rules),
    db: Session = Depends(get_db),
